...
function mostrarTablaCarrito(autos, cartContainer) {
    ...
    autos.forEach(auto => {
        ...
        itemsHTML += `
            <tr>
                <td>
                    <img src="${auto.imagenes[0]}" alt="${auto.modelo}" class="img-fluid rounded" style="max-width: 100px;">
                </td>
                <td>${auto.modelo}</td>
                <td>1</td>
    ...
    const cartTableHTML = `
        <div class="card col-md-10 col-lg-10 mx-auto" id="carrito-reserva-card">
            ...
            <div class="card-header d-flex justify-content-between align-items-center px-4 py-3">
                <a href="home.html#compra" class="btn btn-sm btn-outline-light">
            ...
            <div class="card-footer p-4">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-center text-md-end">
                        ...
                        <h3 class="fw-bold" id="total-reserva-monto">
...
function configurarListenersModal() {
    ...
    if (btnDescargar) {
        btnDescargar.addEventListener('click', generarPDFTicket);
    }
}
...
async function generarPDFTicket() {
    ...
    // =====================
    // ✅ Tabla con bordes rectos estilo factura
    // =====================
    ...
    // =====================
    // ✅ Acción automática después de descargar
    // =====================
